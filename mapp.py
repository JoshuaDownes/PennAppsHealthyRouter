...
class Mapp:
    ...
    def __init__(self, clat, clong, bcoord, fcoord, addressFull, bikeFull, foodFull, farmer):
        self.clat = clat
        self.clong = clong
        self.bcoord = bcoord
        self.fcoord = fcoord
    ...
    def generateMapp(self):
        map_osm = folium.Map(location=[self.bcoord[1], self.bcoord[0]], width=800, height=500, zoom_start=17)
