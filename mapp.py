...
class Mapp:
    ...
    def generateMapp(self):
        ...
        map_osm.circle_marker([self.bcoord[1], self.bcoord[0]], radius=25, popup='Bike Station: Walk here!', fill_color='#0000ff')
        map_osm.circle_marker([self.fcoord[1], self.fcoord[0]], radius=25, popup='Fresh and Delicious Food: Ride here!', fill_color='#00ff00')
